...
def initialize_db(con, cursor):
	...
	create_table(cursor, "`UserAccounts`", "(`id` varchar (20) NOT NULL, `first_name` varchar(25) NOT NULL, `last_name` varchar(50) NOT NULL,"
	...
	insert_items(con, cursor, "Inventory","(id, prod_name, description, price)","(%s,%s,%s,%s)",('1239239CR', 'Server', 'Server Tower'
		     		, '$10.95'))
