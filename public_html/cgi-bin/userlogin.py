...
print "<body>"
print "<h1>Please log in</h1><br>"
print "<form>"
print "User ID:<input type='text' id='userid'><br>"
print "Password:<input type='password' id='passwd'><br>"
print "<input type='submit' value='Login'><br><br>"
print "<p><a href='http://localhost/~coursework/cgi-bin/registration.py'>Register as a new user</a></p>"
print "</form>"
print "</body>"
print "</html>"
